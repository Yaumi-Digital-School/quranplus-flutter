...
|---|---|---|---|---|
| 1 | **604 per-page Quran fonts bundled as assets** — inflates install size significantly | [pubspec.yaml:114](pubspec.yaml#L114) (`data/quran_fonts/`) | Move fonts to remote CDN; download on demand (page currently visible ± N) into app documents dir; cache aggressively. Keep a small core set bundled for offline first-run. | Large |
