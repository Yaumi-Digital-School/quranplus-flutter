...
class _ChangeThemeBottomSheetState
  ...
  Widget build(BuildContext context) {
    final ThemeNotifier themeStateNotifier = ref.read(themeProvider.notifier);
          ...
          children: [
            Expanded(
              child: ThemeBoxOptionWidget(
                ...
                onTap: () async =>
                    _setTheme(QPThemeMode.light, themeStateNotifier),
              ),
            ),
            ...
            Expanded(
              child: ThemeBoxOptionWidget(
                ...
                onTap: () async =>
                    _setTheme(QPThemeMode.dark, themeStateNotifier),
              ),
            ),
            const SizedBox(width: 16),
            Expanded(
              child: ThemeBoxOptionWidget(
                ...
                onTap: () async =>
                    _setTheme(QPThemeMode.brown, themeStateNotifier),
              ),
            ),
          ],
        ),
  ...
  Future<void> _setTheme(QPThemeMode mode, ThemeNotifier themeNotifier) async {
