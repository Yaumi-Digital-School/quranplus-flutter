@Deprecated('Please use QPColors or QPTextStyle instead')
library theme.dart;
...
TextStyle headingBold1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 24,
  fontWeight: bold,
);

TextStyle headingMedium1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 24,
  fontWeight: medium,
);

TextStyle headingRegular1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 24,
  fontWeight: regular,
);

TextStyle subHeadingSemiBold1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 20,
  fontWeight: semiBold,
);

TextStyle subHeadingMedium1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 20,
  fontWeight: medium,
);

TextStyle subHeadingRegular1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 20,
  fontWeight: regular,
);

TextStyle subHeadingSemiBold2 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 16,
  fontWeight: semiBold,
);

TextStyle subHeadingMedium2 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 16,
  fontWeight: medium,
);

TextStyle subHeadingRegular2 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 16,
  fontWeight: regular,
);

TextStyle bodyMedium1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 16,
  fontWeight: medium,
);

TextStyle bodyRegular1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 16,
  fontWeight: regular,
);

TextStyle bodyLight1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 16,
  fontWeight: light,
);

TextStyle bodySemibold2 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 14,
  fontWeight: semiBold,
);

TextStyle bodyMedium2 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 14,
  fontWeight: medium,
);

TextStyle bodyRegular2 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 14,
  fontWeight: regular,
);

TextStyle bodyLight2 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 14,
  fontWeight: light,
);

TextStyle bodyMedium3 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 12,
  fontWeight: medium,
);

TextStyle bodyRegular3 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 12,
  fontWeight: regular,
);

TextStyle bodyLight3 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 12,
  fontWeight: light,
);

TextStyle buttonRegular1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 14,
  fontWeight: regular,
);

TextStyle buttonSemiBold1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 14,
  fontWeight: semiBold,
);

TextStyle buttonMedium1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 14,
  fontWeight: medium,
);

TextStyle buttonSemiBold2 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 12,
  fontWeight: semiBold,
);

TextStyle buttonMedium2 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 12,
  fontWeight: medium,
);

TextStyle buttonMedium3 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 10,
  fontWeight: medium,
);

TextStyle caption1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 12,
  fontWeight: regular,
);

TextStyle captionSemiBold1 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 12,
  fontWeight: semiBold,
);

TextStyle captionRegular2 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 10,
  fontWeight: regular,
);

TextStyle captionLight2 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 10,
  fontWeight: light,
);
...
TextStyle titleDrawerBold = GoogleFonts.poppins(
  color: darkGreen,
  fontSize: 14,
  fontWeight: bold,
);
...
TextStyle bodyLatin1 = GoogleFonts.notoSans(
  color: neutral600,
  fontSize: 12,
  fontWeight: regular,
);

TextStyle regular10 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 10,
  fontWeight: regular,
);

TextStyle regular8 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 8,
  fontWeight: regular,
);

TextStyle semiBold10 = GoogleFonts.notoSans(
  color: neutral900,
  fontSize: 10,
  fontWeight: semiBold,
);
